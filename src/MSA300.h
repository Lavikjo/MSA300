...
/*=========================================================================
    I2C ADDRESS/BITS
    -----------------------------------------------------------------------*/
    #define MSA300_I2C_ADDRESS_WRITE                 (0x4C)    ///< I2C write address. Assumes SDO pulled to GND, otherwise 0x4E
    #define MSA300_I2C_ADDRESS_READ                  (0x4D)    ///< I2C read address. Assumes SDO pulled to GND, otherwise 0x4F
/*=========================================================================*/
